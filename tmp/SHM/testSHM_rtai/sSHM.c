...
#ifdef _WIN32
#else
      dataIN = rtai_malloc(nam2num(SHMNAM_IN), sizeof(struct comStruc_IN));
      dataOUT = rtai_malloc(nam2num(SHMNAM_OUT), sizeof(struct comStruc_OUT));
      printf("%s\n", "start");
#endif
  }
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    y[0] = (float) dataIN->index_counter;
    y[1] = (float) dataIN->sin_value;
    y[2] = (float) dataIN->cos_value;
...
#define MDL_UPDATE  /* Change to #undef to remove function */
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
     ...
     dataOUT->index_counter = (int) u[0];
     //dataOUT->sin_value = (float) u[1];
     //dataOUT->cos_value = (float) u[2];
  }
#endif /* MDL_UPDATE */
